...
saved to the same folder where the original SEM images are located.
...
obtained from Tescan, Zeiss, LEO, SM-32, Thermo Scientific, and, probably, 
FEI (Helios) microscopes.
...
The actual version of the software can be downloaded from our lab's web page
(http://oxide.ru/?q=content/%D0%BF%D0%BE) or from GitHub repository at
